...
function drawAll() {
  ...
  if(showEndingScreen) {
    if(playerScore == maximumScore) {
      text("Bien joué frerot !", canvas.width/2, 100, 'white', 'bold 3em Arial', 'center');
      ...
      text("Tu feras mieux la prochaine fois !", canvas.width/2, 100, 'white', 'bold 3em Arial', 'center');
      text("Score: " + playerScore, canvas.width/2, 250, 'white', 'bold 2em Arial', 'center');
      text("Vie: " + playerAttempts, canvas.width/2, 400, 'white', 'bold 2em Arial', 'center');
